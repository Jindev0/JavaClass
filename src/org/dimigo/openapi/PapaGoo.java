...
public class PapaGoo {

    public static void main(String[] args) {
        String clientId = "aICW8_WSeEYB7z4Y2mvm";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "WX_urvsxJX";//애플리케이션 클라이언트 시크릿값";
        try {
            String text = URLEncoder.encode("집가고 싶다", "UTF-8");
